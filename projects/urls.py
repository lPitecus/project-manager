...
urlpatterns = [
    ...
    # path('project/<int:project_id>/task/edit', views.TaskUpdateView.as_view(), name='edit_task'),
    # path('project/<int:project_id>/task/delete', views.TaskDeleteView.as_view(), name='delete_task'),
]
